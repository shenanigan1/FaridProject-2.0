...
import { TemplatesApi } from '@features/templates_eval/services/template_eval.api';
import { TemplateListItem, TemplateDifficulty } from '@features/templates_eval/models/template_eval.model';
...
@Component({
  ...
  templateUrl: './templates_eval-list.page.html',
