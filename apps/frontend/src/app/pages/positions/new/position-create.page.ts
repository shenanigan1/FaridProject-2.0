...
import { FormPageShellComponent } from '@components/ui/forms/form-page-shell.component';
import { PositionFormComponent } from '@components/ui/forms/position-form.component';
...
@Component({
  ...
  imports: [CommonModule, RouterModule, FormPageShellComponent, PositionFormComponent],
